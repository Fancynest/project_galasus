...
func main() {
	// Konfigurasi koneksi database (mendukung Docker & lokal)
	...
	if userCount == 0 {
		...
		log.Println("Seeder: created default admin (admin@galasus.com / admin)")
	}
	...
	if jwtSecret == "" {
		jwtSecret = "RAHASIA_DAPUR_GALASUS_2026"
	}
